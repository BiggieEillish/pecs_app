...
fun CategoryEditorScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(if (viewModel.isEditing) "Edit category" else "New category") },
                navigationIcon = {
        ...
        Column(
            ...
            Box(modifier = Modifier.size(160.dp), contentAlignment = Alignment.Center) {
                ...
                if (ref != null) {
                    ImageRefImage(imageRef = ref, contentDescription = "Category image", modifier = Modifier.size(160.dp))
                } else {
                    Text("Default icon", color = MaterialTheme.colorScheme.onSurfaceVariant)
                }
